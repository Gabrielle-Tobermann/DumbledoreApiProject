    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         // When configuration is needed, give me the same copy of this configuration for the entire time the app is running.
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SpyDuhApiProject2", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SpyDuhApiProject2 v1"));
            }
